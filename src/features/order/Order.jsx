...
function Order() {
  ...
  //data that is not associaated with this current page right here
  //fetcher like useNavigation have a state(idle,loading,submiting)
  ...
  return (
    <div className="px-4 py-6 space-y-8 ">
      ...
      {!priority && <UpdateOrder>Make Priority</UpdateOrder>}
    </div>
  );
}
export async function loader({ params }) {
  //need to receive the ID from the url,we used params
  //orderId from route order in app.jsx
  //useParams only in component
